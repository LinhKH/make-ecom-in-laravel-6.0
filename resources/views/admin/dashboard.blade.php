  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ls"> <a href="{{ url('admin/view-orders') }}"> <i class="icon-fullscreen"></i> Orders</a> </li>
        <li class="bg_ls"> <a href="{{ url('admin/view-users') }}"> <i class="icon-th-list"></i> Users</a> </li>
