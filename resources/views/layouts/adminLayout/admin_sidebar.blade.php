  ...
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Users</span> <span class="label label-important">3</span></a>
      <ul <?php if (preg_match("/users/i", $url)) { ?> style="display: block;" <?php } ?>>
        ...
        <li <?php if (preg_match("/view-users-charts$/i", $url)) { ?> class="active" <?php } ?>><a href="{{ url('/admin/view-users-charts')}}">View Users Charts</a></li>
        <li <?php if (preg_match("/view-users-country-charts$/i", $url)) { ?> class="active" <?php } ?>><a href="{{ url('/admin/view-users-country-charts')}}">View Users Country Charts</a></li>
      </ul>
    </li>
    @endif
    @if( Session::get('adminDetails')['type'] == "Admin" )
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Admins/Sub-Admins</span> <span class="label label-important">2</span></a>
      <ul <?php if (preg_match("/admins/i", $url)) { ?> style="display: block;" <?php } ?>>
        ...
        <li <?php if (preg_match("/add-admins$/i", $url)) { ?> class="active" <?php } ?>><a href="{{ url('/admin/add-admins')}}">Add Admins/Sub-Admins</a></li>
      </ul>
    </li>
    @endif
    @if( Session::get('adminDetails')['type'] == "Admin" )
