...
class PayumoneyController extends Controller
{
    public function payumoneyPayment(){
        ...
        'order_id' => $order_id,
        'amount' => $grand_total, 
        'firstname' => isset($nameArr[0]) ? $nameArr[0] : '',
        'lastname' => isset($nameArr[1]) ? $nameArr[1] : '',
        'email' => isset($orderDetails->user_email) ? $orderDetails->user_email : '',
        'phone' => isset($orderDetails->mobile) ? $orderDetails->mobile : '',
        'productinfo' => $order_id,
        'service_provider' => '',
        'zipcode' => isset($orderDetails->pincode) ? $orderDetails->pincode : '',
        'city' => isset($orderDetails->city) ? $orderDetails->city : '',
        'state' => isset($orderDetails->state) ? $orderDetails->state : '',
        'country' => isset($orderDetails->country) ? $orderDetails->country : '',
        'address1' => isset($orderDetails->address) ? $orderDetails->address : '',
        'address2' => '',
