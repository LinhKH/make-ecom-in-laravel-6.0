...
Route::group(['middleware'=>['frontlogin']],function(){
	...
	Route::get('/wish-list/delete-product/{id}','ProductsController@delWishListProduct');
});
...
Route::group(['middleware' => ['adminlogin']], function () {
	...
	// Admin Users Country Charts Route
	Route::get('/admin/view-users-country-charts','UsersController@viewUsersCountryCharts');
